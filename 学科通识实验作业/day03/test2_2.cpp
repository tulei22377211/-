 ...
 */
    ...
    double A[3][3] = {{4.0, -2.0, -4.0}, {-2.0, 17.0, 10.0}, {-4.0, 10.0, 9.0}};
    double b[3] = {10.0, 3.0, -7.0};
    //计算D矩阵
 ...
 */
    ...
    // 输出迭代过程
    printf("--------------------------------------------\n");
    printf("inter\tx1\t\tx2\t\tx3\t\tL_infinity\tL_2_error\n");
    printf("--------------------------------------------\n");
    ...
    for (int i = 1; i <= iter; i++){
        printf("%d\t%lf\t%lf\t%lf\t%lf\t%lf\n", i, x[i][0], x[i][1], x[i][2],max(fabs(x[i][0]-x_real[0]),fabs(x[i][1]-x_real[1]),fabs(x[i][2])-x_real[2]), diff[i]);
    }
    printf("--------------------------------------------\n");
