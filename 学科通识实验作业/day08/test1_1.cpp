...
int main(){
    ...
    for (double h = 1.0; h >= 1.0/128; h /= 2.0){
        cout << "1/" << (int)(1/h) << "\t\t" << F_Euler(a, b, t0, y0, h) << "\t" << 3.0*exp(-3/2.0)-2+3.0<< "\t" << 3.0*exp(-3/2.0)-2+3.0 - F_Euler(a, b, t0, y0, h) << endl;
    }
    cout << "---------------" << endl;
    
    /* h = 1.0/100.0;
    cout << F_Euler(a, b, t0, y0, h) << endl;
    cout << B_Euler(a, b, t0, y0, h) << endl;
    cout << PC_B_Euler(a, b, t0, y0, h) << endl; */
