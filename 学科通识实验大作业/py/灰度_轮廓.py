...
# 对比度拉伸
#img_1 = contrast_stretch(img_1)
#img_2 = contrast_stretch(img_2)

# 自适应直方图均衡化
img_1 = adapthist_equalization(img_1)
img_2 = adapthist_equalization(img_2)
...
images = [img_1,img_1,1, img_2,img_2,1,
          ...
          img_1,img_scharr_1,1, img_2,img_scharr_2,1,
          #img_1,img_prewitt_1,1, img_2,img_prewitt_2,1,
          #img_1,img_roberts_1,1, img_2,img_roberts_2,1,
...
titles = ['原图_1', '原图_1','直方图','原图_2', '原图_2','直方图',
          #'原图_1', '边缘检测', '直方图', '原图_2', '边缘检测', '直方图',
          '原图_1', 'Sobel算子', '直方图', '原图_2', 'Sobel算子', '直方图',
          '原图_1', 'Scharr算子', '直方图', '原图_2', 'Scharr算子', '直方图',
          #'原图_1', 'Prewitt算子', '直方图', '原图_2', 'Prewitt算子', '直方图',
          #'原图_1', 'Roberts算子', '直方图', '原图_2', 'Roberts算子', '直方图',
          '原图_1', 'Laplacian算子', '直方图', '原图_2', 'Laplacian算子', '直方图',
...
for i in range(x):
    ...
    plt.imshow(cv2.bitwise_not(images[i * 6+1]), 'gray', vmin=0, vmax=255)
    ...
    # 绘制原图_1
    plt.subplot(x, y, i * 6 + 3)
    plt.imshow(cv2.imread('lena.png',0), 'gray', vmin=0, vmax=255)
    plt.title(titles[i * 6+2], fontsize=8)
    plt.xticks([]), plt.yticks([])
    ...
    plt.imshow(cv2.bitwise_not(images[i * 6+4]), 'gray', vmin=0, vmax=255)
    ...
    # 绘制原图_2
    plt.subplot(x, y, i * 6 + 6)
    plt.imshow(cv2.imread('tian.jpg',0), 'gray', vmin=0, vmax=255)
    plt.title(titles[i * 6+5], fontsize=8)
    plt.xticks([]), plt.yticks([])
