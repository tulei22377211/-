...
#通道分割
b,g,r=cv2.split(img_clr)    #b = img[:, :, 0]


print("\n开始遍历b")
min_b,min_b_a,min_b_b,min_b_c,min_b_norm = bianli_find_min_array(b,b,b)
print("\n开始遍历g")
min_g,min_g_a,min_g_b,min_g_c,min_g_norm = bianli_find_min_array(g,g,g)
print("\n开始遍历r")
min_r,min_r_a,min_r_b,min_r_c,min_r_norm = bianli_find_min_array(r,r,r)
...
images = [img_clr[:,:,[2,1,0]], 0, min_array_rgb[:,:,[2,1,0]], 0]
